...
public class DragonboneSwordLightningItem extends SwordItem {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(new TranslatableText("tooltip." + DragonsArise.MOD_ID + ".dragonbone_sword_lightning.0"));
        tooltip.add(new TranslatableText("tooltip." + DragonsArise.MOD_ID + ".dragonbone_sword_lightning.1"));
