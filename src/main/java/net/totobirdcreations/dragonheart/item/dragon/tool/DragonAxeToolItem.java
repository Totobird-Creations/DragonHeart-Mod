...
public class DragonAxeToolItem extends AxeItem implements DragonItem {

    public final boolean typedDragonItem;


    public DragonAxeToolItem(ToolMaterial material, Settings settings, boolean colouredItem) {
        super(material, 4, -3.0f, settings);
