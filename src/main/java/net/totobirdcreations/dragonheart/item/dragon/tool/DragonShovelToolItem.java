...
public class DragonShovelToolItem extends ShovelItem implements DragonItem {

    public final boolean typedDragonItem;


    public DragonShovelToolItem(ToolMaterial material, Settings settings, boolean colouredItem) {
