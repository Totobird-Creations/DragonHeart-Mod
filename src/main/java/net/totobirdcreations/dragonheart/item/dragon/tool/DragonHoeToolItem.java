...
public class DragonHoeToolItem extends HoeItem implements DragonItem {

    public final boolean typedDragonItem;


    public DragonHoeToolItem(ToolMaterial material, Settings settings, boolean colouredItem) {
