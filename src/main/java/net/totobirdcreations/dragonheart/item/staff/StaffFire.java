...
import net.totobirdcreations.dragonheart.entity.DragonbreathFire;
...
public class StaffFire extends Item {
    ...
    public StaffFire(Settings settings) {
    ...
    public void throwParticle(Entity user) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        if (! world.isClient()) {
            ...
            Dragonbreath entity = new DragonbreathFire(world, (LivingEntity)user);
