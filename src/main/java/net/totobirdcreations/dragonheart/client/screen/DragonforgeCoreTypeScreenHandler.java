...
import net.totobirdcreations.dragonheart.client.screen.util.OutputSlot;
...
public abstract class DragonforgeCoreTypeScreenHandler extends ScreenHandler {
    ...
    public abstract ForgeType getForgeType();
